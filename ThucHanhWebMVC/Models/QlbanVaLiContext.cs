...
public partial class QlbanVaLiContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=HUUTAM;Initial Catalog=QLBanVaLi;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Session>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasMaxLength(449).IsRequired();
            entity.Property(e => e.Value).IsRequired();
            entity.Property(e => e.ExpiresAtTime).IsRequired();
            entity.Property(e => e.SlidingExpirationInSeconds).IsRequired(false);
            entity.Property(e => e.AbsoluteExpiration).IsRequired(false);
        });
