...
namespace ThucHanhWebMVC.Migrations
{
    ...
    [Migration("20240716075436_AddSessionTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.Session", b =>
                {
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TAnhChiTietSp", b =>
                {
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TAnhSp", b =>
                {
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TChatLieu", b =>
                {
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TChiTietHdb", b =>
                {
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TChiTietSanPham", b =>
                {
                    b.Property<string>("MaChiTietSp")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TDanhMucSp", b =>
                {
                    b.Property<string>("MaSp")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.THangSx", b =>
                {
                    b.Property<string>("MaHangSx")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.THoaDonBan", b =>
                {
                    b.Property<string>("MaHoaDon")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TKhachHang", b =>
                {
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TKichThuoc", b =>
                {
                    b.Property<string>("MaKichThuoc")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TLoaiDt", b =>
                {
                    b.Property<string>("MaDt")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TLoaiSp", b =>
                {
                    b.Property<string>("MaLoai")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TMauSac", b =>
                {
                    b.Property<string>("MaMauSac")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TNhanVien", b =>
                {
                    b.Property<string>("MaNhanVien")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TQuocGium", b =>
                {
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TUser", b =>
                {
                    b.Property<string>("Username")
                        .HasMaxLength(100)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TAnhChiTietSp", b =>
                {
                    b.HasOne("ThucHanhWebMVC.Models.TChiTietSanPham", "MaChiTietSpNavigation")
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TAnhSp", b =>
                {
                    b.HasOne("ThucHanhWebMVC.Models.TDanhMucSp", "MaSpNavigation")
                        .WithMany("TAnhSps")
                        .HasForeignKey("MaSp")
                        .IsRequired()
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TChiTietHdb", b =>
                {
                    ...
                    b.HasOne("ThucHanhWebMVC.Models.THoaDonBan", "MaHoaDonNavigation")
                        .WithMany("TChiTietHdbs")
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TChiTietSanPham", b =>
                {
                    b.HasOne("ThucHanhWebMVC.Models.TKichThuoc", "MaKichThuocNavigation")
                        .WithMany("TChiTietSanPhams")
                        .HasForeignKey("MaKichThuoc")
                        .HasConstraintName("FK_tChiTietSanPham_tKichThuoc");

                    b.HasOne("ThucHanhWebMVC.Models.TMauSac", "MaMauSacNavigation")
                        .WithMany("TChiTietSanPhams")
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TDanhMucSp", b =>
                {
                    b.HasOne("ThucHanhWebMVC.Models.TChatLieu", "MaChatLieuNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaChatLieu")
                        .HasConstraintName("FK_tDanhMucSP_tChatLieu");

                    b.HasOne("ThucHanhWebMVC.Models.TLoaiDt", "MaDtNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaDt")
                        .HasConstraintName("FK_tDanhMucSP_tLoaiDT");

                    b.HasOne("ThucHanhWebMVC.Models.THangSx", "MaHangSxNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaHangSx")
                        .HasConstraintName("FK_tDanhMucSP_tHangSX");

                    b.HasOne("ThucHanhWebMVC.Models.TLoaiSp", "MaLoaiNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaLoai")
                        .HasConstraintName("FK_tDanhMucSP_tLoaiSP");

                    b.HasOne("ThucHanhWebMVC.Models.TQuocGium", "MaNuocSxNavigation")
                        .WithMany("TDanhMucSps")
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.THoaDonBan", b =>
                {
                    b.HasOne("ThucHanhWebMVC.Models.TKhachHang", "MaKhachHangNavigation")
                        .WithMany("THoaDonBans")
                        .HasForeignKey("MaKhachHang")
                        .HasConstraintName("FK_tHoaDonBan_tKhachHang");

                    b.HasOne("ThucHanhWebMVC.Models.TNhanVien", "MaNhanVienNavigation")
                        .WithMany("THoaDonBans")
            ...
            modelBuilder.Entity("ThucHanhWebMVC.Models.TKhachHang", b =>
                {
                    b.HasOne("ThucHanhWebMVC.Models.TUser", "UsernameNavigation")
